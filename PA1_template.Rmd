...
The mean is **`r format(round(steps_mean, 2), nsmall = 2)`** and median is **`r format(round(steps_median, 2), nsmall = 2)`**.
...
The mean is **`r format(round(steps_mean_fill, 2), nsmall = 2)`** and median is **`r format(round(steps_median_fill, 2), nsmall = 2)`**.
...
Yes, these values do differ slightly.
  ...
  * Before filling the data
      1. Mean : **`r format(round(steps_mean, 2), nsmall = 2)`**
      2. Median: **`r format(round(steps_median, 2), nsmall = 2)`**
 
  * After filling the data
      1. Mean : **`r format(round(steps_mean_fill, 2), nsmall = 2)`**
      2. Median: **`r format(round(steps_median_fill, 2), nsmall = 2)`**
